  ...
  <footer className="bg-forest-dark text-primary-foreground">
    <div className="container py-16">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
        ...
        {/* Company links */}
        <div>
          <h4 className="font-serif text-base mb-4 text-primary-foreground/90">Company</h4>
        ...
        {/* Government Tenders wing */}
        <div>
          <div className="flex items-center gap-2 mb-4">
            <Landmark className="w-4 h-4 text-blue-300" />
            <h4 className="font-serif text-base text-blue-100">Government Tenders</h4>
          </div>
          <div className="flex flex-col gap-2">
            {[
              { label: "Overview", to: "/government-tenders" },
              { label: "Tender Portfolio", to: "/government-tenders" },
              { label: "Sectors We Cover", to: "/government-tenders" },
              { label: "Submit Inquiry", to: "/government-tenders#inquiry" },
            ].map((l) => (
              <Link key={l.label} to={l.to} className="text-sm opacity-70 hover:opacity-100 transition-opacity">
                {l.label}
              </Link>
        ...
        <div>
          <div className="flex items-center gap-2 mb-4">
            ...
            <h4 className="font-serif text-base text-green-100">Real Estate</h4>
          </div>
          <div className="flex flex-col gap-2">
            {[
        ...
        {/* Sub-Contracting wing */}
        <div>
          <div className="flex items-center gap-2 mb-4">
            <HardHat className="w-4 h-4 text-amber-300" />
            <h4 className="font-serif text-base text-amber-100">Sub-Contracting</h4>
          </div>
          <div className="flex flex-col gap-2">
            {[
              { label: "Our Capabilities", to: "/sub-contracting" },
              { label: "Equipment Fleet", to: "/sub-contracting" },
              { label: "Track Record", to: "/sub-contracting" },
              { label: "Discuss a Package", to: "/sub-contracting#sub-inquiry" },
            ].map((l) => (
              <Link key={l.label} to={l.to} className="text-sm opacity-70 hover:opacity-100 transition-opacity">
                {l.label}
              </Link>
      ...
      <div className="border-t border-primary-foreground/10 mt-12 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm opacity-50">
        <span>© 2026 Vidhima Construction Private Limited. All rights reserved.</span>
