...
const projects = [
  { img: project1, name: "Sharma Residence", type: "Residential", status: "Completed", location: "Near Bundla, Palampur", size: "G+1, 2800 sq ft", timeline: "10 months", desc: "Modern family home with mountain views. RCC frame structure with stone cladding. Full turnkey delivery including modular kitchen and landscaping.", testimonial: "Vidhima Construction made our dream home a reality. Transparent at every step. — Mr. Sharma" },
